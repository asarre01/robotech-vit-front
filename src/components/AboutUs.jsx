...
function AboutUs() {
  return (
    ...
    <section
      id="histoire"
      className=" container min-h-screen mx-auto flex flex-col lg:flex-row flex-1 shrink-0 items-center justify-center py-16  md:py-20 text-alt-200"
    >
      {/* Section 1 */}
      <div className=" min-h-[75vh] grid grid-rows-2 max-w-lg rounded-xl overflow-hidden ">
      ...
      {/* Section 2 */}
      <div className=" min-h-[85vh] max-w-lg bg-primary py-12 px-6 text-alt-100 rounded-xl -translate-y-6 lg:-translate-x-24">
        ...
        <p className="">
          ...
          aliquid culpa, labore ut ad esse, necessitatibus quasi minus rem
          officia animi non, iure accusamus porro cumque! Aperiam sapiente totam
          ...
          officia animi non, iure accusamus porro cumque! Aperiam sapiente totam
          distinctio? Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          Ullam fugiat ipsam tempora accusantium a molestiae? Distinctio
          voluptatem quo tempore asperiores veniam aspernatur molestias rerum
          corporis odio, magnam, saepe labore? Vero! Lorem ipsum dolor sit amet
          consectetur adipisicing elit. Voluptates ex, deleniti nihil harum
          facere, qui exercitationem ipsum aut illum, beatae a numquam? Iste eos
          nisi, neque error dolorum eaque? Impedit?
          <br />
        </p>
        <a href="#contact">
      ...
      {/* Section 3 */}
      <div className="  min-h-[75vh] min-w-lg md:max-w-lg lg:max-w-xl m py-12 px-12 shadow-xl rounded-xl border -mt-12 lg:-ml-28">
        ...
        <div className=" flex flex-col items-center justify-center mt-4 space-y-2 lg:mt-6">
          <div className=" w-full px-4 py-2 ">
            ...
            <p className=" text-justify mt-4">
              ...
              imprimantes 3D, des découpeuses laser et des fraiseuses CNC. Nous
              offrons également un large éventail de kits Arduino, de capteurs,
              de Raspberry Pi, ainsi que des outils électroniques.
            </p>
          </div>
          <div className=" w-full px-4 py-2 ">
            <div className="flex items-center space-x-2 font-bold text-xl">
